...
| 2026-07-12 04:31 | npm package | `newton-browser@0.4.1` | owner-authenticated CLI publish of the verified tarball | publish | Public package reports version 0.4.1, canonical `io.github.Koala-Studios/newton-browser` mcpName, and canonical repository; pinned npx binary reports 0.4.1 | https://www.npmjs.com/package/newton-browser/v/0.4.1 | Public `npm view` plus fresh pinned npx install; logged-out Newton Browser UI check pending transport reconnection | Verify with logged-out Newton Browser before closing Wave 1 |
| 2026-07-12 04:16 | GitHub release | `Koala-Studios/newton-browser` | protected tag workflow run 29178530777 | create release | Hosted release gate passed; v0.4.1 tarball, extension ZIP, checksum, and notes were created before npm workflow auth failed | https://github.com/Koala-Studios/newton-browser/releases/tag/v0.4.1 | Public release URL resolved through GitHub Actions receipt; logged-out Newton Browser UI check pending transport reconnection | Verify assets with logged-out Newton Browser before closing Wave 1 |
