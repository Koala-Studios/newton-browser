...
| --- | --- | --- | --- | --- | --- |
| AIP-01 | [Session command pump](implementation-plans/01-session-command-pump.md) | none | APPROVED | IN PROGRESS — source, deterministic acceptance, stress, packed contract, and concurrent two-host proof pass; connected-browser FIFO/cross-session run pending | `53f5090`; `98fa669`; `8deef3e`; `3ac4d54`; QA-AIP-001/001B |
| AIP-02 | [Transactional lifecycle and framing](implementation-plans/02-transactional-lifecycle-and-framing.md) | AIP-01 contract types | APPROVED | IN PROGRESS — transaction, bounded framing, failure matrix, exact-port restart, clean-user residue, and fresh-process recovery pass; connected MV3 worker-restart run pending | `6be1ef3`; `7451008`–`98b3b2f`; `47ff577`; `b0f1988`; `d9e78f1`; QA-AIP-002 |
| AIP-03 | [Target/frame/session registry](implementation-plans/03-target-frame-session-registry.md) | AIP-01, AIP-02 | APPROVED | IN PROGRESS — bounded registry, composite refs, nested OOPIF routing, excluded-frame MCP provenance, deterministic churn fixture, and live harness pass source gates; connected Chrome/Edge/Linux evidence pending | `a469162`; `d9e78f1`; QA-AIP-003; BB-070 |
| AIP-04 | [Preventive origin containment](implementation-plans/04-preventive-origin-containment.md) | AIP-03 | APPROVED | IN PROGRESS — exact grant compiler, held-target/Fetch prevention, two-origin request counters, security scope, and live zero-request harness integrated; connected live proof pending | `d89543b`; QA-AIP-004; origin/controller/host regressions |
| AIP-05 | [Input and renderer reliability](implementation-plans/05-input-and-renderer-reliability.md) | AIP-01, AIP-03 | APPROVED | IN PROGRESS — source behavior, compiled fixture contracts, provider-free tasks, live key/dialog/stale-target harnesses, and troubleshooting guidance pass; connected Chrome/Edge plus forced lifecycle injections pending | `db62f04`; QA-AIP-005/005B; BB-053–BB-057 |
| AIP-06 | [Agent output efficiency](implementation-plans/06-agent-output-efficiency.md) | AIP-01 result contract | APPROVED | DONE - compact/JSON projections, rich state/provenance, zero-write discovery, normalized actions, observe-on-start, compact status, exact token gates, and installed-tarball compact/JSON parity pass | `90b986a`; `cfcd235`; QA-AIP-006/006B; BB-058-BB-059; Decision 28 |
...
| AIP-08 | [Driver TypeScript hardening](implementation-plans/08-driver-typescript-hardening.md) | AIP-01–AIP-07 stable | APPROVED | IN PROGRESS — strict compiled control path, deterministic output, exhaustive negative gate, compiled tests, and packed artifacts pass; live Chrome/Edge smokes pending | initial 650 diagnostics reduced to 0; current 424-test gate; QA-AIP-008; BB-066–BB-067 |
| AIP-09 | [Regression evals, observability, and release](implementation-plans/09-regression-evals-observability-and-release.md) | incremental; closes after AIP-08 | APPROVED | IN PROGRESS — provider-free corpus, hermetic roots, bounded reports, local command metrics, framing doctor facts, root/CI/release wiring, provenance, and three consecutive 13-stage release passes complete; connected live matrix pending | `78d7bb5`; `4577a3f`; QA-AIP-009/009B; Decision 31; live gate pending |
...
| Integrated AIP-01–AIP-09 deterministic gate | pass | 2026-08-09 | lint/typecheck pass; 418 tests total, 416 passed, the same 2 noncritical platform socket skips, 0 failed; provider-free eval 43/43; six token gates pass; installed spaced-path tarball exposes 11 tools and compact/JSON parity |
| `pnpm smoke:extension-ready` (10-second bounded probe) | environmental gate | 2026-08-09 | `ready:false`, `errorCode:"extension_disconnected"`, `secretExposed:false`; no live-browser claim made |
| Final exact-tree deterministic gate | pass | 2026-08-09 | commit `4577a3f`; 422 tests total, 420 passed, the same 2 noncritical platform socket skips, 0 failed; provider-free eval 43/43; catalog 2,818/3,000 and workflow 776/2,100 tokens |
| `pnpm release:check` three consecutive times | pass | 2026-08-09 | 13/13 stages each; durations 440.4s, 439.9s, 439.1s; stress operations 3,493,768 / 3,538,380 / 3,676,881; zero cross-results, same-session overlaps, deadlocks, runtime residue, or newly orphaned host ports |
| Final extension/tarball artifacts | pass | 2026-08-09 | extension ZIP 410,176 bytes, SHA-256 `829e077171951ffe795e891f18572f1caee80bf24d1df90b29f8b39f4d46a56c`; MCP tarball 152,081 bytes, SHA-256 `057bf841adac3d2a909314c3cb4959344df7ac2513c1a682030c7e0ce4a737cf` |
| Post-fix `pnpm smoke:extension-ready` bounded probe | environmental gate | 2026-08-09 | `ready:false`, `errorCode:"extension_disconnected"`, `elapsedMs:10887`, `secretExposed:false`; process exits cleanly after bounded child shutdown; BB-072 |
| Live-harness configuration gate | pass | 2026-08-09 | all audit live scripts use one strict Chrome/Edge selector, default to Chrome, scan the bounded host range when no exact port is requested, and record the selected family/actual port; lint/typecheck pass; 424 tests total, 422 passed, 2 known noncritical platform skips, 0 failed; BB-073 |
...
| 2026-08-09 | Reused all three GPT-5.6 Sol medium workers for non-overlapping AIP-01/02, AIP-03/04, and AIP-05/09 acceptance lanes. Orchestrator review corrected an invalid live origin, compact-vs-JSON observation assumptions, source-import test leakage, optional-fixture target churn, semantic-ref strict-validation ordering, and dropped excluded-frame provenance before integration. The root deterministic suite is 418 tests with 0 failures; live execution remains explicitly gated by the disconnected extension. | QA-AIP-001B–QA-AIP-009; BB-068–BB-070; `test/evidence/audit-improvement-program.md` |
| 2026-08-09 | Completed the final three-pass release sequence on unchanged commit `4577a3f`. The orchestrator rejected a false global-empty-port assumption after it misclassified pre-existing task-owned MCP hosts, then fixed a readiness-probe timer/lost-wakeup defect and restarted the sequence. All three final 13-stage passes succeeded; connected Chrome/Edge acceptance remains the only environmental gate. | QA-AIP-009B; BB-071–BB-072; artifact hashes in the checkpoint record |
| 2026-08-09 | Continued the connected-browser completion audit. Chrome was running but Newton remained disconnected; browser security correctly prevented automated inspection of `chrome://extensions`. The audit then fixed inconsistent Chrome/Edge selection and the hard-coded busy host port across every AIP live harness, added a deterministic runbook, and re-ran lint, typecheck, and the complete root suite. | BB-073; `test/live-smoke-config.test.mjs`; `docs/RELEASE.md` |
