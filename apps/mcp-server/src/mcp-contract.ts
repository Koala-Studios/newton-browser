export const MCP_SERVER_INSTRUCTIONS = [
  ...
  "A session-owned popup or new tab becomes the active page automatically; re-observe the same session and never click browser chrome or a debugger banner.",
