import { keyDescriptor, normalizeKey, type KeyDescriptor } from "./key-description.ts";
export { keyDescriptor, normalizeKey, type KeyDescriptor } from "./key-description.ts";
